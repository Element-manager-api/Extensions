...
pipeline {
    ...
    stages {
        ...
        //         def token = getAuthToken("Agent1", "Welcome1", "https://em-232.dv.dev.rightnow.com/cgi-bin/em_232.cfg")
        //         //def zip = readFile(file: "${extensionName}/${extensionName}.zip", encoding: "Base64")
